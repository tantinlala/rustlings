...
impl TryFrom<(i16, i16, i16)> for Color {
    ...
    fn try_from(tuple: (i16, i16, i16)) -> Result<Self, Self::Error> {
        let (Ok(red), Ok(green), Ok(blue)) = (u8::try_from(tuple.0), u8::try_from(tuple.1), u8::try_from(tuple.2)) else {
...
impl TryFrom<[i16; 3]> for Color {
    ...
    fn try_from(arr: [i16; 3]) -> Result<Self, Self::Error> {
        let (Ok(red), Ok(green), Ok(blue)) = (u8::try_from(arr[0]), u8::try_from(arr[1]), u8::try_from(arr[2])) else {
            return Err(IntoColorError::IntConversion);
        };
...
impl TryFrom<&[i16]> for Color {
    ...
    fn try_from(slice: &[i16]) -> Result<Self, Self::Error> {
        ...
        let (Ok(red), Ok(green), Ok(blue)) = (u8::try_from(slice[0]), u8::try_from(slice[1]), u8::try_from(slice[2])) else {
            return Err(IntoColorError::IntConversion);
        };
